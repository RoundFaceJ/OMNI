# 在mmdetection/mmdet/models/detectors/detr.py中修改pos_embed = torch.zeros_like(pos_embed)，将其置为0
MAX_EPOCH = 300
NUM_WORKERS = 32
...
work_dir = '/mnt/nvme0n1/xpj_files/project/OMNI/mmdetection/work_dirs3/detr/detr_r50_300_omni_without_positional_encoding' #