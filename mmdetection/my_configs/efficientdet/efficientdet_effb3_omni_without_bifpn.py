...
model = dict(
    ...
    bbox_head=dict(
        ...
        feat_channels=384,  # 对应 C5 的通道数
        in_channels=384,  # 对应 C5 的通道数
...
work_dir = '/mnt/nvme0n1/xpj_files/project/OMNI/mmdetection/work_dirs3/efficientdet/efficientdet_effb3_omni_without_bifpn' #