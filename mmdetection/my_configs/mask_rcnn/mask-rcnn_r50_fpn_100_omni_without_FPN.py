...
launcher = 'pytorch'
load_from = "/mnt/nvme0n1/xpj_files/project/OMNI/mmdetection/checkpoints/mask_rcnn/mask_rcnn_r50_fpn_mstrain-poly_3x_coco_20210524_201154-21b550bb.pth"
log_level = 'INFO'
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_roi_extractor=dict(
            featmap_strides=[32],  # 对应 C5 的下采样倍数
            out_channels=2048,  # C5 的通道数
...
work_dir = '/mnt/nvme0n1/xpj_files/project/OMNI/mmdetection/work_dirs3/mask-rcnn/mask-rcnn_r50_fpn_100_omni_without_FPN'
